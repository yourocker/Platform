    ...
    public static class DbInitializer
    {
        public static async Task Initialize(AppDbContext context)
        {
            ...
            var systemApps = new List<AppDefinition>
            {
                ...
                // РЕГИСТРАЦИЯ СПРАВОЧНИКА УСЛУГ
                new AppDefinition { Name = "Услуги", EntityCode = "ServiceItem", Icon = "cart-check", IsSystem = true, AppCategoryId = catServices?.Id },
                new AppDefinition { Name = "Категории услуг", EntityCode = "ServiceCategory", Icon = "folder2", IsSystem = true, AppCategoryId = catServices?.Id }
            };
